...
function createSignature(context, kind, signature, declaration, commentDeclaration) {
    ...
    if (predicate) {
        ...
        sigRef.type = context.converter.convertType(context.withScope(sigRef), signature.getReturnType());
    }
...
function convertParameters(context, sigRef, parameters, parameterNodes) {
    return parameters.map((param, i) => {
        ...
        paramRefl.type = context.converter.convertType(context.withScope(paramRefl), declaration
