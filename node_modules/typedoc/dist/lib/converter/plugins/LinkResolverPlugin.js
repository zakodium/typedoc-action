...
let LinkResolverPlugin = class LinkResolverPlugin extends components_1.ConverterComponent {
    ...
    onResolve(context) {
        ...
        for (const { type, owner } of (0, reflections_1.discoverAllReferenceTypes)(context.project, false)) {
            if (!type.reflection) {
                const resolveResult = context.converter.resolveExternalLink(type.toDeclarationReference(), owner);
