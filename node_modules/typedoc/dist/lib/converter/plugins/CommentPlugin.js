...
let CommentPlugin = CommentPlugin_1 = class CommentPlugin extends components_1.ConverterComponent {
     ...
     */
    onDeclaration(_context, reflection, node) {
        var _a, _b;
        if (!node) {
            return;
        }
        ...
        if (reflection.kindOf(index_2.ReflectionKind.Namespace)) {
        ...
        if (reflection.kindOf(index_2.ReflectionKind.Module)) {
            const tag = (_a = reflection.comment) === null || _a === void 0 ? void 0 : _a.getTag("module");
            if (tag) {
                reflection.name = tag.text.trim();
                utils_1.removeIfPresent((_b = reflection.comment) === null || _b === void 0 ? void 0 : _b.tags, tag);
            }
        }
    }
    /**
    ...
    onBeginResolve(context) {
        ...
        const [allRemoved, someRemoved] = lodash_1.partition(hidden
