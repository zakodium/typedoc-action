...
export declare type SomeType = ArrayType | ConditionalType | IndexedAccessType | InferredType | IntersectionType | IntrinsicType | LiteralType | PredicateType | ReferenceType | ReflectionType | TupleType | TypeOperatorType | TypeParameterType | UnionType | UnknownType;
